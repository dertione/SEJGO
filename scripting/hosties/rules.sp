...
Rules_OnPluginStart()
{
	...
	gH_Cvar_Rules_Mode = CreateConVar("sm_hosties_rules_mode", "2", "1 - Panel Mode, 2 - Website", 0, true, 1.0, true, 2.0);
	gShadow_Rules_Mode = 2;
	
	gH_Cvar_Rules_Website = CreateConVar("sm_hosties_rules_website", "http://s.supreme-elite.fr/regle/reglese.html", "The website for the rules page.", 0);
	Format(gShadow_Rules_Website, sizeof(gShadow_Rules_Website), "http://s.supreme-elite.fr/regle/reglese.html");
